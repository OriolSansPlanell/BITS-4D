...
class BiTS4DMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        km_info = QLabel(
            ...
            "3-D k-means clustering. Results are stored as segmentation layers\n"
            "and are immediately available for RF training."
        )
        ...
        self.rf_train_btn.setToolTip(
            ...
            "Run '✂ Segment Current' on that timepoint first."
        )
